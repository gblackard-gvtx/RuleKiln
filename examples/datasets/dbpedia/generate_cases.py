...
# From dbpedia_14. Run --discover-labels to verify against dataset.
LABEL_NAMES = [
    "Company",
...
def _write_cases_to_file(
    ...
    for i, row in enumerate(rows[:limit]):
        ...
        case: dict[str, object] = {
            ...
            "id": f"dbpedia_{target_split}_{i:06d}",
            "split": target_split,
            "task_mode": "classification",
            "input": {"description": str(row["content"])},
            ...
            "metadata": {"source": "dbpedia_14", "label_id": label_id},
            "weight": 1.0,
        }
