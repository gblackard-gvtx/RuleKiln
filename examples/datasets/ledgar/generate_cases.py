...
# From lex_glue/ledgar. Run --discover-labels to verify against dataset.
LABEL_NAMES = [
    "Adjustments",
    "Agreements",
    "Amendments",
...
def _write_cases_to_file(
    ...
    for i, row in enumerate(rows[:limit]):
        ...
        case: dict[str, object] = {
            ...
            "id": f"ledgar_{target_split}_{i:06d}",
            "split": target_split,
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Generate RuleKiln cases for LEDGAR")
    parser.add_argument(
        "--discover-labels",
        action="store_true",
